...
public class ExcelExportUtils {
     ...
     * @return
     */
    public static void export(String excelTitleData, List<Object> data, HttpServletRequest request, HttpServletResponse response){
                ...
                if(cols != null && cols.size() > 0){
                    ...
                    for(int j = 0; j < cols.size(); j++){
                        ...
                        if(cell != null && (cell.getBoolean("hidden") == null || cell.getBoolean("hidden") != null && !cell.getBoolean("hidden") )
                            ...
                            //设置样式
                            sheet.setColumnWidth(colNum,title.length()*1000);
                    ...
                    for (Object obj : cells) {
                        ...
                        if(cell != null) {
                            ...
                            if (dataSelect != null && !"".equals(dataSelect)) {
                                hssfCell.setCellValue(row.get(field) != null ? getSelectValue(dataSelect, row.get(field).toString()) : "");
                            } else {
                                hssfCell.setCellValue(row.get(field) != null ? row.get(field).toString() : "");
                            }
                            //合并单元格
     ...
     * @param cs
     */
    private static void setStyleRegion(HSSFSheet sheet, CellRangeAddress region, HSSFCellStyle cs) {
     ...
     * @param style
     */
    private static void setStyleAlign(String align, HSSFCellStyle style){
     ...
     * 列头单元格样式
     */
    private static HSSFCellStyle setColumnTopStyle(HSSFWorkbook workbook) {
        // 设置字体
